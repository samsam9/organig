<?php
    ...
    /* Mailchimp setting */
    define('MC_APIKEY', 'ddd0e31fc3fa517221a437b77c635512-us16'); // Your API key from here - http://admin.mailchimp.com/account/api
    define('MC_LISTID', '44423e31dd'); // List unique id from here - http://admin.mailchimp.com/lists/
